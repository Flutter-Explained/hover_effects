...
class GlassHoverEffect extends StatefulWidget {
  static void navigate(context) {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => const GlassHoverEffect(),
      ),
    );
  }

  const GlassHoverEffect({super.key});

  @override
  State<GlassHoverEffect> createState() => _GlassHoverEffectState();
}

class _GlassHoverEffectState extends State<GlassHoverEffect>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Glass Hover Effect")),
